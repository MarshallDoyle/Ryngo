...
| Phase 5.1.2 — Python tree-sitter extractor | unclaimed | next | `mvp/lib/parsers/queries/py/*.scm` + `mvp/lib/parsers/py-tree-sitter.js`. Same shape as TS; reuses the runtime. |
