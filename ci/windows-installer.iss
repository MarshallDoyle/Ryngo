; Ryngo Windows Installer — Inno Setup Script
; RYNGO: Rebranded from WezTerm
; vim:ts=2:sw=2:et:

#define MyAppName "Ryngo"
;#define MyAppVersion "1.5"
#define MyAppPublisher "Marshall Doyle"
#define MyAppURL "https://github.com/MarshallDoyle/Ryngo"
#define MyAppExeName "ryngo-gui.exe"

[Setup]
AppId={{E7A3C2F1-9B4D-4E8A-B6C5-3F2D1A8E9B7C}
...
OutputDir=..
OutputBaseFilename=Ryngo-Setup
...
[Files]
Source: "..\target\release\ryngo.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\target\release\ryngo-gui.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\target\release\ryngo-mux-server.exe"; DestDir: "{app}"; Flags: ignoreversion
...
[Icons]
Name: "{autoprograms}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; AppUserModelID: "dev.ryngo.terminal"
Name: "{autodesktop}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; Tasks: desktopicon; AppUserModelID: "dev.ryngo.terminal"

[Run]
Filename: "{app}\{#MyAppExeName}"; Description: "{cm:LaunchProgram,{#StringChange(MyAppName, '&', '&&')}}"; Flags: nowait postinstall skipifsilent

[Registry]
Root: HKA; Subkey: "Software\Classes\Drive\shell\Open Ryngo here"; Flags: uninsdeletekey
Root: HKA; Subkey: "Software\Classes\Drive\shell\Open Ryngo here"; ValueName: "icon"; ValueType: string; ValueData: "{app}\{#MyAppExeName}"; Flags: uninsdeletekey;
Root: HKA; Subkey: "Software\Classes\Drive\shell\Open Ryngo here\command"; ValueType: string; ValueData: """{app}\{#MyAppExeName}"" start --no-auto-connect --cwd ""%V\"""; Flags: uninsdeletekey;
Root: HKA; Subkey: "Software\Classes\Directory\Background\shell\Open Ryngo here"; Flags: uninsdeletekey
Root: HKA; Subkey: "Software\Classes\Directory\Background\shell\Open Ryngo here"; ValueName: "icon"; ValueType: string; ValueData: "{app}\{#MyAppExeName}"; Flags: uninsdeletekey;
Root: HKA; Subkey: "Software\Classes\Directory\Background\shell\Open Ryngo here\command"; ValueType: string; ValueData: """{app}\{#MyAppExeName}"" start --no-auto-connect --cwd ""%V"; Flags: uninsdeletekey;
Root: HKA; Subkey: "Software\Classes\Directory\shell\Open Ryngo here"; Flags: uninsdeletekey
Root: HKA; Subkey: "Software\Classes\Directory\shell\Open Ryngo here"; ValueName: "icon"; ValueType: string; ValueData: "{app}\{#MyAppExeName}"; Flags: uninsdeletekey;
Root: HKA; Subkey: "Software\Classes\Directory\shell\Open Ryngo here\command"; ValueType: string; ValueData: """{app}\{#MyAppExeName}"" start --no-auto-connect --cwd ""%V\\"""; Flags: uninsdeletekey;
